...
namespace Horspool
{
    public class BoyerMooreHorspool
    {
        ...
        public List<int> Find(string haystack, string needle)
        {
            ...
            while (index <= haystack.Length - needle.Length)
                ...
                if (index < haystack.Length - needle.Length)
                {
                    for (int i = needle.Length - 1; i >= 0; i--)
                    {
                        ...
                        {
                            match = false;
                            index = index + BadMatchTable[haystack[index + needle.Length - 2]];
            ...
            //                index = index + BadMatchTable[haystack[(index + (needle.Length - 1))]];    /*BadMatchTable ı düzenleyebilirmiyiz*/
            //                karsilastirmasayaci = karsilastirmasayaci + 1;
